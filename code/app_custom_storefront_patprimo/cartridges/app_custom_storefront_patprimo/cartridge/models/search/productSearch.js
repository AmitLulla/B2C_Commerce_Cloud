...
var DEFAULT_PAGE_SIZE = preferences.defaultPageSize ? preferences.defaultPageSize : 32;
...
function getShowMoreUrl(productSearch, httpParams) {
  ...
  var count = paging.getPageCount();
  var baseUrlOne = productSearch.url(showMoreEndpoint) + '&start=0&sz=' + pageSize;
  pages.push(baseUrlOne);
