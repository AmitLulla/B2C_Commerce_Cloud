var path = require('path');
    ...
    module.exports = [{
        ...
        output: {
            path: path.resolve('./cartridges/int_gift_certificate/cartridge/static'),
            filename: '[name].js'
        },
        resolve: {
            alias: {
                ...
                bootstrapSelect: path.resolve(__dirname, '../int_gift_certificate/node_modules/bootstrap-select')
            }
        }
    }, {
        mode: 'none',
