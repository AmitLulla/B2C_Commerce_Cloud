var path = require('path');
    ...
    module.exports = [{
        ...
        output: {
            path: path.resolve('./cartridges/int_pago_contra_entrega/cartridge/static'),
            filename: '[name].js'
        },
        resolve: {
            alias: {
                ...
                bootstrapSelect: path.resolve(__dirname, '../int_pago_contra_entrega/node_modules/bootstrap-select')
            }
        }
    }, {
        mode: 'none',
