var path = require('path');
    ...
    module.exports = [{
        ...
        output: {
            path: path.resolve('./cartridges/int_social_selling/cartridge/static'),
            filename: '[name].js'
        },
        resolve: {
            alias: {
                ...
                bootstrapSelect: path.resolve(__dirname, '../int_social_selling/node_modules/bootstrap-select')
            }
        }
    }, {
        mode: 'none',
