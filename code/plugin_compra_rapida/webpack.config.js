var path = require('path');
    ...
    module.exports = [{
        ...
        output: {
            path: path.resolve('./cartridges/plugin_compra_rapida/cartridge/static'),
            filename: '[name].js'
        },
        resolve: {
            alias: {
                ...
                bootstrapSelect: path.resolve(__dirname, '../plugin_compra_rapida/node_modules/bootstrap-select')
            }
        }
    }, {
        mode: 'none',
