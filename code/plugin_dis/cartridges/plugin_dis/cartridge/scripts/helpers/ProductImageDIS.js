...
var imageConfigDISJSON = !empty(Site.current.preferences.custom.imageConfigDIS) ? JSON.parse(Site.current.preferences.custom.imageConfigDIS) : '';
if (!empty(imageConfigDISJSON)) {
    cvDISConfiguration = imageConfigDISJSON;
}
