...
module.exports.render = function (context, modelIn) {
    ...
    model.categoryURL1 = URLUtils.https('Search-Show', 'cgid', content.categoryLink1.getID()).toString();
    model.categoryURL2 = URLUtils.https('Search-Show', 'cgid', content.categoryLink2.getID()).toString();
    model.categoryURL3 = URLUtils.https('Search-Show', 'cgid', content.categoryLink3.getID()).toString();
    model.categoryURL4 = URLUtils.https('Search-Show', 'cgid', content.categoryLink4.getID()).toString();
    model.categoryURL5 = URLUtils.https('Search-Show', 'cgid', content.categoryLink5.getID()).toString();
    ...
    return new Template('experience/components/homepage/catDestacadosPara').render(model).text;
};
